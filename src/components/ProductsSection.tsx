...
const ProductsSection = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      varieties: ["Queso", "Pollo"],
      image: "/Imagen de WhatsApp 2025-09-16 a las 19.39.48_1d840fbd.jpg",
    ...
    },
    {
      ...
      varieties: ["Con Queso", "Con Huevo", "Combo Completo"],
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                {/* Order Button */}
                <a
                  href={`https://wa.me/59898409482?text=Hola! Me interesa pedir ${product.title}`}
                  target="_blank"
