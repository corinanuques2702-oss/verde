...
const Gallery = () => {
  ...
  const galleryImages = [
    ...
    },
    {
      ...
      title: "Patacones Clásicos"
    },
    {
      id: 3,
      src: "/Imagen de WhatsApp 2025-09-16 a las 19.39.48_1d840fbd.jpg",
      alt: "Empanadas de verde con huevo",
      title: "Empanadas Especiales"
    },
    {
      id: 4,
      src: "/Imagen de WhatsApp 2025-09-16 a las 19.39.48_05d54a29.jpg",
      alt: "Tortillas de verde doradas",
      title: "Tortillas Doradas"
    }
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-green-50 to-yellow-50 rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <a
              href="https://wa.me/59898409482?text=Hola! Quiero hacer un pedido"
              target="_blank"
